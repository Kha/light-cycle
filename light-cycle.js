...
(function() {
  ...
  Grid = (function() {
    ...
    Grid.prototype.set = function(x, pos) {
      if (this.contains(pos)) {
        return this.grid[pos.x][pos.y] = x;
      }
    };
    ...
    Grid.prototype.contains = function(pos) {
      var _ref, _ref1;
      return (0 <= (_ref = pos.x) && _ref < this.width) && (0 <= (_ref1 = pos.y) && _ref1 < this.height);
    };
  ...
  game = {
    ...
    start: function(canvas) {
      var _this = this;
      if (!(this.ctx = canvas.getContext("2d"))) {
        return;
      }
    ...
    createBorder: function() {
      ...
      for (x = _i = 1, _ref = this.width - 2; 1 <= _ref ? _i <= _ref : _i >= _ref; x = 1 <= _ref ? ++_i : --_i) {
        new Char("-", v(x, 0));
    ...
    refresh: function(pos) {
      ...
      _results = [];
      for (x = _i = _ref = pos.x - 2, _ref1 = pos.x + 2; _ref <= _ref1 ? _i <= _ref1 : _i >= _ref1; x = _ref <= _ref1 ? ++_i : --_i) {
        _results.push((function() {
          var _j, _ref2, _ref3, _ref4, _results1;
          _results1 = [];
          for (y = _j = _ref2 = pos.y - 2, _ref3 = pos.y + 2; _ref2 <= _ref3 ? _j <= _ref3 : _j >= _ref3; y = _ref2 <= _ref3 ? ++_j : --_j) {
            _results1.push((_ref4 = this.grid.get(v(x, y))) != null ? _ref4.draw() : void 0);
          }
          return _results1;
        }).call(this));
      }
  ...
  Match = (function() {
    ...
    Match.prototype.initPoint = function() {
      ...
      this.updateScore();
      return this.back = Char.drawString("Back", v(-1, game.grid.height - 1));
    };
    ...
    Match.prototype.onTouchStart = function(pos, identifier) {
      ...
      if (this.back.any((function(c) {
        return c.pos.eq(pos2);
      }))) {
        return game.setScreen(function() {
          return new Menu();
        });
  ...
  Player = (function() {
    ...
    Player.prototype.onKeyDown = function(char) {
      ...
      if (idx !== -1) {
        this.newdir = Vector.dirs[idx];
      }
      if (this.newdir.neg().eq(this.dir)) {
        return this.newdir = this.dir;
      }
    };
    ...
    Player.prototype.onTouchMove = function(pos, touchId) {
      var delta, max;
      if (this.touchId !== touchId || !(this.touchStart != null)) {
        return;
      }
